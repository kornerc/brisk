...
#           
            ...
            CXXLIBS="$RPATH $MLIBS -lm -Wl,-rpath,../lib -lbrisk -lagast -lopencv_core -lopencv_features2d -lopencv_imgproc -lopencv_calib3d -lopencv_highgui -lopencv_core -lopencv_flann"
...
#
            ...
            CXXLIBS="$MLIBS -lm -Wl,-rpath,../lib -lbrisk -lagast -lopencv_core -lopencv_features2d -lopencv_imgproc -lopencv_calib3d -lopencv_highgui -lopencv_core -lopencv_flann"
            CXXOPTIMFLAGS='-O -DNDEBUG'
#
            LD="$COMPILER"
            LDEXTENSION='.mexs64'
...
#
            ...
            CXXLIBS="$MLIBS -lstdc++ -Wl,-rpath,../lib -lbrisk -lagast -lopencv_core -lopencv_features2d -lopencv_imgproc -lopencv_calib3d -lopencv_highgui -lopencv_core -lopencv_flann"
